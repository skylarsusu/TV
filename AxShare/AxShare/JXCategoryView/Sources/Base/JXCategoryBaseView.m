...
- (instancetype)initWithFrame:(CGRect)frame scrollDerection:(UICollectionViewScrollDirection)scrollDirection {
    self = [super initWithFrame:frame];
    if (self) {
        self.scroll_derection = scrollDirection;
        [self initializeData];
        [self initializeViews];
    }
    return self;
...
//    layout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    layout.scrollDirection = self.scroll_derection;
