...
- (UIButton *)settingBtn {
    if (!_settingBtn) {
        ...
        [_settingBtn setImage:[UIImage imageNamed:@"setting"] forState:UIControlStateSelected];
        
        _settingBtn.frame = CGRectMake(SCREEN_WIDTH-50, 10, 25, 25);
    }
    return _settingBtn;
}
...
- (JXCategoryBaseView *)preferredCategoryView {
    return [[JXCategoryBaseView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, [self preferredCategoryViewHeight]) scrollDerection:UICollectionViewScrollDirectionHorizontal];
}
